...
def parse_arguments(notebook_options=None):
    ...
    parser.add_argument('--max-train-epochs', type=int, default=150, help='number of training epochs. [default: 100]')
    ...
    parser.add_argument('--patience', type=int, default=50, help='if test-acc does not improve for patience consecutive'
                                                                 'epoch, stop training.')

    #
    # Model arguments
    #
    parser.add_argument('--model', type=str, default='transrefer3d', choices=['transrefer3d'])
    parser.add_argument('--object-latent-dim', type=int, default=128)
    parser.add_argument('--position-latent-dim', type=int, default=6)
